...
export const CONTENT: Record<'en' | 'ar', SiteContent> = {
  ar: {
    ...
    services: {
      title: "خدمات التفتيش",
      items: [
        { title: "التفتيش الغذائي", description: "المنتجات الغذائية – مواد الخام – الحبوب – البذور", icon: "Wheat" },
        { title: "التفتيش الطبي", description: "أدوية – معدات طبية - مستلزمات المعامل", icon: "Stethoscope" },
        { title: "التفتيش الصناعي", description: "مواد نصف مصنعة – مستلزمات التشغيل – الآلات", icon: "Factory" },
        { title: "التفتيش النفطي", description: "نفط خام – مشتقات نفطية – بتروكيماويات – معدات الانتاج والحفر", icon: "Droplet" },
